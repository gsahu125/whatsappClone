    ...
    return (
        <ScrollView style={styles.container}>
                    ...
                    <TouchableOpacity style={styles.listView}>
                            <Image
                            style={{flex:2,width:50,height:50,marginTop:-10}}
                            ...
                            />
                            <View style={{flex:7}}><Text style={{fontSize:16,fontWeight:'bold'}}>New Group</Text><Text style={{opacity:0.6}}>Good morning msg</Text></View>
                        ...
                        <TouchableOpacity style={styles.listView}>
                            ...
                            source={{uri:'https://w7.pngwing.com/pngs/104/119/png-transparent-orange-and-white-logo-computer-icons-icon-design-person-person-miscellaneous-logo-silhouette.png'}}
                            />
                            <View style={{flex:7}}><Text style={{fontSize:16,fontWeight:'bold'}}>New Contact</Text><Text style={{opacity:0.6}}>Good morning msg</Text></View>
                            <View style={{flex:1}}><Ionicons name="videocam-outline" size={25} color="green"/></View>
                        </TouchableOpacity>
                        </View>
